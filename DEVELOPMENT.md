...
- **Piano (鋼琴專區)**：整合多重來源。除了新曲外，專門爬取 [piano.php](https://www.ufret.jp/piano.php) 以及 [ピアノ 標籤搜尋頁面](https://www.ufret.jp/pickup.php?tag=%E3%83%94%E3%82%A2%E3%83%8E)；且關鍵在於**「強制標記」**與**「全局掃描」**——只要是從專屬頁面抓到的曲目，都會被強制標記為鋼琴曲並存入全局資料庫，確保歷史抓取的鋼琴譜（如您提到的 8 首）永不遺失。
